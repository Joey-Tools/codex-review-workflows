...
- Focused catalog-reload, legacy-overlap, and cleanup-quarantine namespace regressions: 6 tests passed.
- Python 3.13 full suite: 860 tests passed, 9 skipped.
- Python 3.10.19 full suite: 860 tests passed, 9 skipped.
- `ruff check` and `ruff format --check` on changed runtime and test modules: passed.
