...
- Process cleanup uses OS containment or PID-plus-start-identity descendant tracking rather than trusting a bare PGID, and sink closure has its own 10-second deadline.
