...
- The repository-level `codex-review-gate.yml` automation was removed because it auto-started an extra Codex PR gate on ordinary PR events. GitHub Codex is now requested only by the named-triple exact-comment flow; single, double, and effective-double PRs do not inherit a hidden reviewer.
