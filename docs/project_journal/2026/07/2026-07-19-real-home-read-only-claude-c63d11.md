...
- Full local suite: 681 tests passed.
- Live Claude Code 2.1.212 probes verified that the model-backed scrub opt-out preserves effective `permissionMode: plan`, while native sandbox credential rules block protected-variable Bash access.
...
- Independent focused reviews of the subprocess-scrub compatibility fix and staging-cleanup race hardening: no findings.
