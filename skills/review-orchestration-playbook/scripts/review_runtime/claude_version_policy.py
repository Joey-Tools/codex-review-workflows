...
CLAUDE_GUARD_OWNED_SESSION_MINIMUM_VERSION = (2, 1, 226)
...
def requires_guard_owned_session(version: str) -> bool:
    """Return whether the named-direct lane must bind a guard-owned session."""
