...
EXPECTED_HOSTED_ROLLOUT_CODESIGN_SHA256="214d455584d19abc0d74d02b9cbc7d3da6bdcb0596c235e6156dd9ed2f4e1ba7"
...
EXPECTED_HOSTED_ROLLOUT_OS_VERSION="26.5.2"
EXPECTED_HOSTED_ROLLOUT_OS_BUILD="25F84"
...
select_hosted_codesign_sha256() {
  ...
  case "$os_version:$os_build" in
    "$EXPECTED_HOSTED_OS_VERSION:$EXPECTED_HOSTED_OS_BUILD")
      ...
      ;;
    "$EXPECTED_HOSTED_ROLLOUT_OS_VERSION:$EXPECTED_HOSTED_ROLLOUT_OS_BUILD")
      printf '%s\n' "$EXPECTED_HOSTED_ROLLOUT_CODESIGN_SHA256"
      ;;
