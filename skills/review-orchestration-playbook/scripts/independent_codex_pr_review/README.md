...
256-bit 不可预测 leaf 与 cooperative same-UID host TCB。receipt 建立后，工具绑定
identity/access policy、使用 exclusive stage 和 descriptor traversal；一旦观察到
identity-unproven 或 mismatch，就保留对象且绝不删除当前 replacement。GitHub Hosted
