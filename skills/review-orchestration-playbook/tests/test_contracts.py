...
class RepositoryContractTest(unittest.TestCase):
    ...
    def test_independent_codex_process_output_is_task_scoped_and_bounded(self) -> None:
        ...
        self.assertIn("bounded FIFO/pipe sink or quota-bounded target", readiness)
        ...
        self.assertIn("stat every output artifact again", readiness)
        ...
        self.assertIn("bounded FIFO/pipe sink", contracts)
        ...
        self.assertIn("stat both process logs and the final-message artifact", contracts)
