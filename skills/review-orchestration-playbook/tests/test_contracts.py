...
class RepositoryContractTest(unittest.TestCase):
    ...
    def test_independent_codex_process_output_is_task_scoped_and_bounded(self) -> None:
        ...
        self.assertIn("terminate the entire group", readiness)
        self.assertIn("Wait for every group member to exit", readiness)
        self.assertIn("close inherited sinks", readiness)
        self.assertIn("stat both process logs again", readiness)
        self.assertIn("even after exit zero", readiness)
        self.assertIn("group exit cannot be confirmed", readiness)
        ...
        self.assertIn("send `KILL` to the group", contracts)
        ...
        self.assertIn("Wait for the whole group to exit", contracts)
        self.assertIn("close every inherited log sink", contracts)
        self.assertIn("group exit cannot be confirmed", contracts)
