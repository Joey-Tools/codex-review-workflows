...
- `inconclusive`: transient/capacity/timeout/network failure, Claude output overflow, drain/reap or initial-process-group/inherited-stream cleanup uncertainty, malformed/partial output, or no trustworthy terminal artifact.
