...
Every diff-producing Git command disables external diff drivers and text conversion. Missing objects must surface as `range-incomplete`; the reviewer never fetches.
