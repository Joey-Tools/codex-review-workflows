...
- Named triple review 必须委托给当前 `$review-orchestration-playbook` 及其 GitHub Codex evidence authority 和 machine contracts；本地 delivery skill 不复制 request-plane、terminal grammar、receipt/migration、retry/liveness、manual admission、retarget 或 readiness 的字段级合同。
